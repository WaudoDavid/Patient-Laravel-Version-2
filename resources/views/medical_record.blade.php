  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action= "{{url('upload_records')}}" method= "post">
                    @csrf     

         <div class="form-group">
            <label for="exampleInputpatientid">Patient ID</label>
            <input type="text" class="form-control" id="exampleInputpatientid" name ="patient_no" placeholder="Patient ID" style="color: white !important;" required>
           </div>
