<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="{{url('adminpage')}}"><img src="assets/images/hos.svg"
                alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="{{url('adminpage')}}"><img src="assets/images/hos2.svg"
                alt="logo" /></a>
    </div>
    <ul class="nav">
